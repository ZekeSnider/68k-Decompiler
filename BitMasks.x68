...
BitMask6to8 
      MOVE.L   %0000000111000000,D1       ;Storing the mask to D1
      MOVE.L   D0,D7                      ;Copying the input line to D7
      AND.L    D1,D7                      ;ANDING the Data
...
BitMask6to8 
      MOVE.L   %0000000011000000,D1       ;Storing the mask to D1
      MOVE.L   D0,D7                      ;Copying the input line to D7
      AND.L    D1,D7                      ;ANDING the Data
      LSR      #6,D7                      ;Shifting the irrelavant bits out the right side
      RTS
...
BitMask3to5 
      MOVE.L   %0000000000111000,D1       ;Storing the mask to D1
      MOVE.L   D0,D7                      ;Copying the input line to D7
      AND.L    D1,D7                      ;ANDING the Data
...
BitMask0to2 
      MOVE.L   %0000000000000111,D1       ;Storing the mask to D1
      MOVE.L   D0,D7                      ;Copying the input line to D7
      AND.L    D1,D7                      ;ANDING the Data
      RTS
...
BitMask14to15 
      MOVE.L   %1100000000000000,D1       ;Storing the mask to D1
      MOVE.L   D0,D7                      ;Copying the input line to D7
      AND.L    D1,D7                      ;ANDING the Data
...
BitMask12to13 
      MOVE.L   %0011000000000000,D1       ;Storing the mask to D1
      MOVE.L   D0,D7                      ;Copying the input line to D7
      AND.L    D1,D7                      ;ANDING the Data
      LSR      #12,D7                      ;Shifting the irrelavant bits out the right side
      RTS
...
BitMask8to15 
      MOVE.L   %1111111100000000,D1       ;Storing the mask to D1
      MOVE.L   D0,D7                      ;Copying the input line to D7
      AND.L    D1,D7                      ;ANDING the Data
...
BitMask7to15 
      MOVE.L   %1111111110000000,D1       ;Storing the mask to D1
      MOVE.L   D0,D7                      ;Copying the input line to D7
      AND.L    D1,D7                      ;ANDING the Data
...
BitMaskSubQ 
      MOVE.L   %1111000100000000,D1       ;Storing the mask to D1
      MOVE.L   D0,D7                      ;Copying the input line to D7
      AND.L    D1,D7                      ;ANDING the Data
      RTS
